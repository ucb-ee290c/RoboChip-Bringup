...
int simple_functional_test() {
    ...
    float t_row4[11] = {1.1, 2.2, 3.3, -424.4, 7, 1.1, 2.2, 3.3, -4.4, 7, 1.1};
    ...
    float t_row5[12] = {1.1, 2.2, 3.3, -424.4, 7, 1.1, 2.2, 3.3, -4.4, 7, 1.1, 2.2};
    ...
    float t_row6[13] = {1.1, 2.2, 3.3, -424.4, 7, 1.1, 2.2, 3.3, -4.4, 7, 1.1, 2.2, 3.3};
    ...
    float t_row7[14] = {1.1, 2.2, 3.3, -424.4, 7, 1.1, 2.2, 3.3, -4.4, 7, 1.1, 2.2, 3.3, -4.4};
    ...
    float t_row8[16] = {1.1, 2.2, 3.3, -424.4, 7, 1.1, 2.2, 3.3, -4.4, 7, 1.1, 2.2, 3.3, -4.4, 7, 13.8};
    ...
    float t_row9[17] = {1.1, 2.2, 3.3, -424.4, 7, 1.1, 2.2, 3.3, -4.4, 7, 1.1, 2.2, 3.3, -4.4, 7, 13.8, -20.4};
    ...
    float t_row10[18] = {1.1, 2.2, 3.3, -424.4, 7, 1.1, 2.2, 3.3, -4.4, 7, 1.1, 2.2, 3.3, -4.4, 7, 13.8, -20.4, 38.5};
    ...
    float t_row11[19] = {1.1, 2.2, 3.3, -424.4, 7, 1.1, 2.2, 3.3, -4.4, 7, 1.1, 2.2, 3.3, -4.4, 7, 13.8, -20.4, 38.5, -0.3};
    ...
    float t_row12[20] = {1.1, 2.2, 3.3, -424.4, 7, 1.1, 2.2, 3.3, -4.4, 7, 1.1, 2.2, 3.3, -4.4, 7, 13.8, -20.4, 38.5, -0.3, 33};
